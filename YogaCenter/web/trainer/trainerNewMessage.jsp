                ...
                <div class="col-lg-3" style="padding: 0">
                    ...
                    <div class="col-lg-8">
                        <div style="height: 40px; width: 100%; margin-top: 10px; margin-bottom: 10px">
                            <a href="/YogaCenter/trainermessage" class="btn">
                    ...
                    <form action="/YogaCenter/request" method="POST">
                        ...
                        <button name="action" value="TrainerAddMessage" style="margin-top: 30px; float: right" class="btn btn-primary">Send</button>
                    </form>
                </div>
            </div>
        </div>
