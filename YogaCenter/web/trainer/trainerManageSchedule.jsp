                                                                ...
                                                                <c:forEach var="acc" items="${listClass}">
                                                                    <c:choose>
                                                                        <c:when test="${acc.datestudy == day.getDate() && acc.time == 1 && day.getDay() == 'Sunday'}">
                                                                            <p><a href="/YogaCenter/request?action=inf&id=${acc.id_class}&option=trainerClassDetail&date=${acc.datestudy}&acc=${acc.idaccount}">${acc.account}(${acc.class_name}) - ${acc.course} </a></p> 
                                                                        </c:when>
                                                                        <c:otherwise>
                                                                        </c:otherwise>
                                                                    </c:choose>
