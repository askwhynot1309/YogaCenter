...
<html>
    ...
    <head>
        <title>Trainer Check Attendance</title>
            ...
            <div class="row">
                ...
                <div class="col-lg-9" style="margin-left: 300px">
                    <div style="height: 40px; width: 100%; margin-top: 10px; margin-bottom: 10px">
                        <a href="/YogaCenter/trainercheckattendance" class="btn">
                            ...
                            <form action="/YogaCenter/request">
                                <div class="tabel-container">
                                    ...
                                    <div class="text-center mt-3">
                                        ...
                                        <button type="submit" name="action" value="SubmitAttendanceDetail" class="btn btn-primary">Submit</button>
                                    </div>
                                </div>
                            </form>
                        </c:if>
