                                                            ...
                                                            <c:forEach var="acc" items="${listClass}">
                                                                <c:choose>
                                                                    <c:when test="${acc.datestudy == day.getDate() && acc.time == 1 && day.getDay() == 'Sunday'}">
                                                                        <p><a href="/YogaCenter/request?action=inf&id=${acc.id_detail}&option=classDetail">${acc.course}(${acc.class_name})</a></p> 
                                                                    </c:when>
                                                                    <c:otherwise>
                                                                    </c:otherwise>
                                                                </c:choose>
                                                            ...
                                                            <c:forEach var="acc" items="${listClass}">
                                                                <c:choose>
                                                                    <c:when test="${acc.datestudy == day.getDate() && acc.time == 4 && day.getDay() == 'Saturday'}">
                                                                        <p><a href="/YogaCenter/request?action=inf&id=${acc.id_detail}&option=infclassDetail">${acc.course}(${acc.class_name})</a></p> 
                                                                    </c:when>
                                                                    <c:otherwise>
                                                                    </c:otherwise>
                                                                </c:choose>
