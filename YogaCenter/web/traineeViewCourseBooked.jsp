                            ...
                            <div class="table-responsive table-borderless">
                                <table class="table">
                                    ...
                                    <tbody class="table-body">
                                        ...
                                        %>
                                        <tr class="cell-1">
                                            <th><a href="/YogaCenter/request?action=ClassDetail&option=viewmore&id=<%=course.getIdCourse()%>"><%= course.getName_course()%></a></th>
                                                            ...
                                                            <c:forEach var="acc" items="${listClass}">
                                                                <c:choose>
                                                                    <c:when test="${acc.datestudy == day.getDate() && acc.time == 1 && day.getDay() == 'Sunday'}">
                                                                        <p><a href="/YogaCenter/request?action=ClassDetail&id=${acc.id_class}&option=classDetail&date=${acc.datestudy}&acc=${acc.idaccount}">${acc.account}(${acc.class_name})</a></p> 
                                                                    </c:when>
                                                                    <c:otherwise>
                                                                    </c:otherwise>
                                                                </c:choose>
