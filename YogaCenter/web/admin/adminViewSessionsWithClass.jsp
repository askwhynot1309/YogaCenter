                                ...
                                <tbody>
                                    <c:forEach var="course" items="${listSession}" varStatus="loop">
                                        <tr>
                                            ...
                                            <td>${course.date}</td>
                                            <td>
                                                <a href="/YogaCenter/request?action=inf&id=${course.id_class}&course2=${course2}&idclass=${course.id_course}&option=adminviewTrainees" class="btn btn-primary">View detail</a>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                </tbody>
