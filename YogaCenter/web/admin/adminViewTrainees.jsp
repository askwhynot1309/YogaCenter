            ...
            <div class="row">
                <div class="col-lg-3" style="padding: 0">
                    ...
                    <div style="height: 40px; width: 100%; margin-top: 10px; margin-bottom: 10px">
                        <a href="/YogaCenter/request?action=inf&id=${idclass3}&option=viewCourse" class="btn">
                                ...
                                <tbody>
                                    <c:forEach var="course" items="${listSessions}" varStatus="loop">
                                        <tr>
                                            ...
                                            <td>
                                                <a href="/YogaCenter/request?action=inf&id=${course.idaccount}&idclass=${id}&idcourse=${idclass3}&option=ViewTraineeInClassInformation" class="btn btn-primary">View Trainee</a>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                </tbody>
