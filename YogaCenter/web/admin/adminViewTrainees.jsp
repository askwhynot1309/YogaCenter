                                ...
                                <tbody>
                                    <c:forEach var="course" items="${listSessions}" varStatus="loop">
                                        <tr>
                                            ...
                                            <td>
                                                <a href="/YogaCenter/request?action=inf&id=${course.idaccount}&room=${room}&idcourse=${id}&option=ViewTraineeInClassInformation" class="btn btn-primary">View Trainee</a>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                </c:if>
