                                    ...
                                    <c:if test="${currentDate != null}">
                                        <c:forEach var="course" items="${listCourse}" varStatus="loop">
                                            <tr>
                                                ...
                                                <td>
                                                    <c:if test="${course.date_close.after(currentDate)}">
                                                        <a href="/YogaCenter/request?action=inf&id=${course.idCourse}&option=infCourse" class="btn btn-primary">Change information</a>
                                                    </c:if>
                                                        <a href="/YogaCenter/request?action=inf&id=${course.idCourse}&option=viewCourse" class="btn btn-primary">More information</a>
