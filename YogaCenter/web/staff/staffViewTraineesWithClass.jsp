                                ...
                                <tbody>
                                    <c:forEach var="course" items="${listSessions}" varStatus="loop">
                                        <tr>
                                            ...
                                            <td>
                                                <a href="/YogaCenter/request?action=inf&id=${course.idaccount}&idclass=${id}&idcourse=${idclass3}&option=staffViewTraineeInClassInformation" class="btn btn-primary">View Trainee</a>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                </tbody>
