        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-3" style="padding: 0">
                    ...
                    <div class="col-lg-9">
                    <c:set var="idclass2" value="${requestScope.idclass2}"/>
                    <c:set var="course3" value="${requestScope.course3}"/>
                    <div style="height: 40px; width: 100%; margin-top: 10px; margin-bottom: 10px">
                        <a href="/YogaCenter/request?action=inf&id=${idclass2}&course=${course3}&option=staffviewDetailSession" class="btn">
                    ...
                    <c:set var="listTraineeInClass" value="${requestScope.listTraineeInClass}"/>
                    <h3>List trainee in Session</h3>
                    <c:if test="${listTraineeInClass.size() > 0 && !listTraineeInClass.isEmpty()}">
                        <div>
                            <table class="table">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    <c:forEach var="course" items="${listTraineeInClass}" varStatus="loop">
                                        <tr>
                                            <td>${loop.count}</td>
