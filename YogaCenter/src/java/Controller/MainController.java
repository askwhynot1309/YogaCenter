            ...
            if (action == null) {
                ...
                switch (action) {
                    ...
                    case "OTPRegister":
                        ...
                        break;
                    case "OTPChangePassword":
                        url = "SubmitOTPChangePasswordServlet";
                        break;
                    case "Reset":
                    ...
                    case "Ok":
                        ...
                        break;
                    case "AddMessage":
                        url = "ButtonAddNewMessageServlet";
                        break;
                    case "StaffAddMessage":
                        url = "StaffButtonAddNewMessageServlet";
                        break;
