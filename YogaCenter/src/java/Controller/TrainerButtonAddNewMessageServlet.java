 ...
 * @author ADMIN
 */
public class TrainerButtonAddNewMessageServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            if (account == null) {
                request.getRequestDispatcher("trainernewmessage").forward(request, response);
            }
            ...
            switch (option) {
                case 0:
                    if (send == "") {
                        boolean createMessage = Dao.MessageDao.createRequestChangeClass(account.getIdaccount(), message, 1, 0, date, title);
