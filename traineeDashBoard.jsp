                                                                        ...
                                                                        <c:forEach var="acc" items="${listClass}">
                                                                            <c:choose>
                                                                                <c:when test="${acc.datestudy == day.getDate() && acc.time == 1 && day.getDay() == 'Sunday'}">
                                                                                    <span class="badge badge-primary"><a style="color: white" href="/YogaCenter/request?action=ClassDetail&id=${acc.id_class}&option=classDetail&datestudy=${acc.datestudy}">${acc.course}(${acc.class_name})</a></span><p class="text-danger">${AttendenceDao.attendanceStatus(acc.idaccount, acc.id_class, acc.datestudy)}</p> 
                                                                                </c:when>
                                                                                <c:otherwise>
                                                                                </c:otherwise>
                                                                            </c:choose>
                                                                        ...
                                                                        <c:forEach var="acc" items="${listClass}">
                                                                            <c:choose>
                                                                                <c:when test="${acc.datestudy == day.getDate() && acc.time == 1 && day.getDay() == 'Monday'}">
                                                                                    <span class="badge badge-primary"><a style="color: white" href="/YogaCenter/request?action=ClassDetail&id=${acc.id_class}&option=classDetail&datestudy=${acc.datestudy}">${acc.course}(${acc.class_name})</a></span>
                                                                                    <p class="text-danger">${AttendenceDao.attendanceStatus(acc.idaccount, acc.id_class, acc.datestudy)}</p> 
                                                                                </c:when>
                                                                                <c:otherwise>
                                                                                </c:otherwise>
                                                                            </c:choose>
                                                                        ...
                                                                        <c:forEach var="acc" items="${listClass}">
                                                                            <c:choose>
                                                                                <c:when test="${acc.datestudy == day.getDate() && acc.time == 4 && day.getDay() == 'Saturday'}">
                                                                                    <p><a style="color: white" href="/YogaCenter/request?action=ClassDetail&id=${acc.id_class}&option=ClassDetailclassDetail">${acc.course}(${acc.class_name})</a></p>
                                                                                    <p class="text-danger">${AttendenceDao.attendanceStatus(acc.idaccount, acc.id_class, acc.datestudy)}</p> 
                                                                                </c:when>
                                                                                <c:otherwise>
                                                                                </c:otherwise>
